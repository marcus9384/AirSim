...
#include "vehicles/multirotor/api/CarRpcLibClient.hpp"
#include "yaml-cpp/yaml.h"
#include <airsim_ros_car_pkgs/GimbalAngleEulerCmd.h>
#include <airsim_ros_car_pkgs/GimbalAngleQuatCmd.h>
#include <airsim_ros_car_pkgs/GPSYaw.h>
#include <airsim_ros_car_pkgs/Land.h>
#include <airsim_ros_car_pkgs/LandGroup.h>
#include <airsim_ros_car_pkgs/Reset.h>
#include <airsim_ros_car_pkgs/Takeoff.h>
#include <airsim_ros_car_pkgs/TakeoffGroup.h>
#include <airsim_ros_car_pkgs/VelCmd.h>
#include <airsim_ros_car_pkgs/VelCmdGroup.h>
#include <chrono>
...
private:
    ...
    void vel_cmd_world_frame_cb(const airsim_ros_car_pkgs::VelCmd::ConstPtr& msg, const std::string& vehicle_name);
    void vel_cmd_body_frame_cb(const airsim_ros_car_pkgs::VelCmd::ConstPtr& msg, const std::string& vehicle_name);

    void vel_cmd_group_body_frame_cb(const airsim_ros_car_pkgs::VelCmdGroup& msg);
    void vel_cmd_group_world_frame_cb(const airsim_ros_car_pkgs::VelCmdGroup& msg);

    void vel_cmd_all_world_frame_cb(const airsim_ros_car_pkgs::VelCmd& msg);
    void vel_cmd_all_body_frame_cb(const airsim_ros_car_pkgs::VelCmd& msg);

    // void vel_cmd_body_frame_cb(const airsim_ros_car_pkgs::VelCmd& msg, const std::string& vehicle_name);
    void gimbal_angle_quat_cmd_cb(const airsim_ros_car_pkgs::GimbalAngleQuatCmd& gimbal_angle_quat_cmd_msg);
    void gimbal_angle_euler_cmd_cb(const airsim_ros_car_pkgs::GimbalAngleEulerCmd& gimbal_angle_euler_cmd_msg);

    // void set_zero_vel_cmd();

    /// ROS service callbacks
    bool takeoff_srv_cb(airsim_ros_car_pkgs::Takeoff::Request& request, airsim_ros_car_pkgs::Takeoff::Response& response, const std::string& vehicle_name);
    bool takeoff_group_srv_cb(airsim_ros_car_pkgs::TakeoffGroup::Request& request, airsim_ros_car_pkgs::TakeoffGroup::Response& response);
    bool takeoff_all_srv_cb(airsim_ros_car_pkgs::Takeoff::Request& request, airsim_ros_car_pkgs::Takeoff::Response& response);
    bool land_srv_cb(airsim_ros_car_pkgs::Land::Request& request, airsim_ros_car_pkgs::Land::Response& response, const std::string& vehicle_name);
    bool land_group_srv_cb(airsim_ros_car_pkgs::LandGroup::Request& request, airsim_ros_car_pkgs::LandGroup::Response& response);
    bool land_all_srv_cb(airsim_ros_car_pkgs::Land::Request& request, airsim_ros_car_pkgs::Land::Response& response);
    bool reset_srv_cb(airsim_ros_car_pkgs::Reset::Request& request, airsim_ros_car_pkgs::Reset::Response& response);
    ...
    airsim_ros_car_pkgs::GPSYaw get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const;
...
private:
    ...
    ros::Publisher origin_geo_point_pub_; // home geo coord of cars
    msr::airlib::GeoPoint origin_geo_point_;// gps coord of unreal origin 
    airsim_ros_car_pkgs::GPSYaw origin_geo_point_msg_; // todo duplicate
    ...
    // todo for multiple cars with multiple sensors, this won't scale. make it a part of CarROS?
